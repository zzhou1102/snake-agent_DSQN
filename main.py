...
class Game:
    ...
    def train(self, n, m, pars):
        ...
        pars: parameters passed in for each processor
        """
        # initialize
        record = 0
...
if __name__ == "__main__":
    """
    enter number 1 to train the model
    enter number 2 to test the best model from ./model
    """
    Game(1)
